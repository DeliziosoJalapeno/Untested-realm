// FAQ 5: with Magellan Globe in play, a 2x2 AREA effect (Earthquake) may be anchored on the edge —
// the picker offers edge anchors and the area wraps to the opposite edge.
...
describe('Magellan Globe — Earthquake edge anchor (FAQ 5)', () => {
